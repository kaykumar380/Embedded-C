...
// GPIO Unlock functions

void unlockGPIOport(char port)
{
	/*GPIO Lock (GPIOLOCK)
GPIO Port A (APB) base: 0x4000.4000
GPIO Port B (APB) base: 0x4000.5000
...
Type RW, reset 0x0000.0001*/
	...
	// A corressponding port register has to be written by 0x4C4F_434B to unlock
	
	if (port == 'A')
    *((unsigned int*) 0x40004520U) = 0x4C4F434B;
  else if (port == 'B')
    *((unsigned int*) 0x40005520U) = 0x4C4F434B;
  else if (port == 'C')
    *((unsigned int*) 0x40006520U) = 0x4C4F434B;
  else if (port == 'D')
    *((unsigned int*) 0x40007520U) = 0x4C4F434B;
  else if (port == 'E')
    *((unsigned int*) 0x40024520U) = 0x4C4F434B;
  else *((unsigned int*) 0x40025520U) = 0x4C4F434B;
