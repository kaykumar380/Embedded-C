...
//  unsigned int* pfclken = (unsigned int*)0x400FE608U;
//  unsigned int* pfdir   = (unsigned int*)0x40025400U;
//  unsigned int* pfden   = (unsigned int*)0x4002551CU;
//  unsigned int* pfdata  = (unsigned int*)0x400253F0U;
//  
//  *pfclken = 0x20U;
//  *pfdir = 0x0EU;
//  *pfden = 0x0EU;
//  *pfdata = 0x0EU;
  writeDIGITAL_GPIO('F',0x0E,0x08);
  while(1)
  {
    writeDIGITAL_GPIO('B',0xFF,0x20);
    delaay(1000000);
    writeDIGITAL_GPIO('B',0xFF,0x00);
    delaay(1000000);
  }
  return 0;
}
